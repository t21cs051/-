...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # 電流測定データを取得
        measurement_queryset = CurrentMeasurement.objects.all().order_by('-measurement_date')[:10]

        # 作業記録データを取得
        worklog_queryset = WorkLog.objects.all().order_by('-work_date')[:10]
        ...
        context['history_data'] = [
            {
                ...
                'type': '電流' if hasattr(entry, 'measurement_date') else '作業',
